    ...
    def __init__(self, dfTrain, dfPred, maxValue, selectSubsTopPercent, pathModel,
        ...
        if (trainModel or
            ...
            def trainModel(model, xTrain, xTest, yTrain, yTest, tag, lastModel=False):
                ...
                # Inspect results
                saveModel = False
                # print(f'Inspect: {pink}{tag}{resetColor}\n'
                #       f'Evaluation Metric: {pink}{indexEvalMetric}')
...
class PredictActivity:
    def __init__(self, enzymeName, datasetTag, folderPath, subsTrain, topSubsPercent,
        ...
        self.topSubsPercent = topSubsPercent
    ...
    def predictionAccuracies(self):
        ...
        for tag, values in self.modelAccuracy.items():
            ...
            print(f'Accuracies: {pink}{tag}\n'
                  f'{greenLight}{values}{resetColor}\n')
            print(f'Saving Model Accuracies:\n'
                  f'     {greenDark}{pathSave}{resetColor}\n\n')
